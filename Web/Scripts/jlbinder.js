...
$.fn.binder.methods = {
                    ...
                    var loopindex = 0;
                        for (rowindex in rows) {
                            if (rows.hasOwnProperty(rowindex)) {
                                ...
                                loopindex++;
                                this.loopandsetvalues(t,tid,loopindex,
                                    rowindex,
                                    rowobject,
                                    foreachi,
                                    allowedinputs,
    ...
    loopandsetvalues: function (t,tid,loopindex, rowindex, rowobject,foreachi, allowedinputs, excludedelements, templatedetailsobj, html,parenttag, pagesize, pagevalue) {
