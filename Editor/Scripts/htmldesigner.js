...
var hdstylemenu = '<style>a, a:focus, a:hover {color: inherit !important;text-decoration: none;}</style><div id="absolutestyleeditor" style="position: fixed;bottom: 0px;width: 100%;" ><div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="margin-bottom: 0px;"><div class="panel panel-success"><div class="panel-heading" style="padding: 4px;"><h6 class="panel-title">   <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseStyle" style="font-size: 12px !important;" aria-expanded="true"  aria-controls="collapseStyle">Style Editor</a></h6></div> <div id="collapseStyle" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne"><div class="panel-body" ><div class="panel-group" id="hdstylemenu" role="tablist" aria-multiselectable="false"></div></div></div></div></div></div>';
